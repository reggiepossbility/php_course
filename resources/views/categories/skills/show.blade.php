...
@section('content')
    ...
    <div class="card border-0 mb-3 ">
        <div class="card-header h1">{{ $skill->name }}</div>
        <div class="card-body">
            <div class="row">
            ...
            <div class="row">
                ...
                <p class="card-text">{{ $skill->time }}</p>
            </div>

            <div class="row">
                <h5 class="card-title">地點：</h5>
                <p class="card-text">{{ $skill->venue }}</p>
            </div>

            <div class="row">
                <h5 class="card-title">內容：</h5>
                <p class="card-text bk_line">{{ $skill->detail }}</p>
            </div>
            ...
            <div class="row mt-3 d-flex justify-content-end ">
                ...
                <div class="mr-3">
                    <form action="{{ route('save.skill', $skill->id) }}" method="POST">
                        @csrf
                ...
                <div class="mr-3">
                    <form action="{{ route('join.skill', $skill->id) }}" method="POST">
                        @csrf
                ...
                <div class="mr-3">
                    <a class="btn btn-outline-success" href="{{ route('skills.edit', $skill) }}">編輯</a>
                </div>
